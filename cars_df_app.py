...
st.set_page_config(page_title = 'Car Companies',
                    page_icon = ':car:',
                    layout = 'centered',
                    initial_sidebar_state = 'auto')
car_df = load_data()
st.title('Cars Prediction')
...
options = st.sidebar.radio('Move to', tuple(pages_dict))
current_page = pages_dict[options]
current_page.app(car_df)
